As stated in the [introduction](index.md), `arisensdk` integrates with ARISEN-based blockchains using the [ARISEN Nodeos RPC API](https://developers.eos.io/arisen-nodeos/reference).
